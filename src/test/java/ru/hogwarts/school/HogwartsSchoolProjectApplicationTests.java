...
class HogwartsSchoolProjectApplicationTests {
    @Autowired
...
//        when(avatarService.findAvatarById(any(Long.class))).thenReturn(avatar);
//        when(facultyService.findFaculty(any(Long.class))).thenReturn(faculty);
//        when(studentService.findStudent(any(Long.class))).thenReturn(new Student());
